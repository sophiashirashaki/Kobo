...
async def inline_help_func(__HELP__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/05a1fdada665ccbc27971.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/KoboKanaeru_Robot"),
        InlineKeyboardButton(
    ...
    msg = f"""
**[Kobokan ❤️](https://t.me/KoboKanaeru_Robot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](https://t.me/KoboKanaeru_Robot) | [UBOT](https://t.me/Humaaancarees) | [DEV](https://t.me/erosei_1)
**Repo:** [Kobo-Robot](https://t.me/projectsupdates/26)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
...
async def music_inline_func(answers, query):
    ...
    group_invite = "https://t.me/AkoUpdate"
    try:
        messages = [
            m
