...
from EmikoRobot.modules.sql.afk_redis import (
    afk_reason,
    end_afk,
    is_user_afk,
    start_afk,
...
@emikomsg((Filters.all & Filters.chat_type.groups), friendly='afk', group=AFK_GROUP)
...
@emikomsg((Filters.all & Filters.chat_type.groups & ~Filters.update.edited_message), friendly="afk", group=AFK_REPLY_GROUP)
